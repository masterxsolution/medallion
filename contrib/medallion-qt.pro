...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/medallion-cli.cpp \
           src/medallion-tx.cpp \
           src/medallion.cpp \
           src/db.cpp \
           ...
           src/qt/medallion.cpp \
           src/qt/medallionstrings.cpp \
...
RESOURCES += src/qt/medallion.qrc src/qt/medallion_locale.qrc

TRANSLATIONS += src/qt/locale/medallion_bg.ts \
                src/qt/locale/medallion_de.ts \
                src/qt/locale/medallion_en.ts \
                src/qt/locale/medallion_es.ts \
                src/qt/locale/medallion_fi.ts \
                src/qt/locale/medallion_fr.ts \
                src/qt/locale/medallion_it.ts \
                src/qt/locale/medallion_ja.ts \
                src/qt/locale/medallion_pl.ts \
                src/qt/locale/medallion_pt.ts \
                src/qt/locale/medallion_ru.ts \
                src/qt/locale/medallion_sk.ts \
                src/qt/locale/medallion_sv.ts \
                src/qt/locale/medallion_vi.ts \
                src/qt/locale/medallion_zh_CN.ts \
                src/qt/locale/medallion_zh_TW.ts
