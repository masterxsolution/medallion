...
#   c) node1 mines 32 blocks, so now node 0 has 60001medallion, node 1 has 4250medallion, node2 has none.
#   d) node0 sends 601 medallion to node2, in two transactions (301 medallion, then 300 medallion).
