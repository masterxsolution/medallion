Contributing to MDL Core
============================

The MDL Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MDL Core project, and is not to be
confused with overall MDL Network Protocol consensus changes.

Whether a pull request is merged into MDL Core rests with the project merge
...
Patches that change MDL consensus rules are considerably more involved than
...
Where a patch set proposes to change the MDL consensus, it must have been
...
The project leader is the release manager for each MDL Core release.
