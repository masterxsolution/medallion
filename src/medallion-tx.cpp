...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Medallion Core medallion-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  medallion-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded medallion transaction") + "\n" +
                               "  medallion-tx [options] -create [commands]   " + _("Create hex-encoded medallion transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded medallion transaction
