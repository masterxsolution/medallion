                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Medallion from zMedallion"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMedallion"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMedallion));
