                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MDL Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MDL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and medallion: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMDL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MDL Core"), this);
    aboutAction->setStatusTip(tr("Show information about MDL Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MDL"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MDL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MDL addresses"));
    ...
    openAction->setStatusTip(tr("Open a MDL: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MDL Core help message to get a list with possible MDL command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MDL Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MDL network", "", count));
}
...
{
    QString strTitle = tr("MDL Core"); // default title
