...
/** Utility functions used by the MDL Qt UI.
 */
namespace GUIUtil
{
...
// Render MDL addresses in monospace font
...
// Parse "medallion:" URI into recipient object, return true on successful parsing
