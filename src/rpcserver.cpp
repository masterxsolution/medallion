...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Medallion features */
        {"medallion", "masternode", &masternode, true, true, false},
        {"medallion", "listmasternodes", &listmasternodes, true, true, false},
        {"medallion", "getmasternodecount", &getmasternodecount, true, true, false},
        {"medallion", "masternodeconnect", &masternodeconnect, true, true, false},
        {"medallion", "masternodecurrent", &masternodecurrent, true, true, false},
        {"medallion", "masternodedebug", &masternodedebug, true, true, false},
        {"medallion", "startmasternode", &startmasternode, true, true, false},
        {"medallion", "createmasternodekey", &createmasternodekey, true, true, false},
        {"medallion", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"medallion", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"medallion", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"medallion", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"medallion", "getmasternodescores", &getmasternodescores, true, true, false},
        {"medallion", "mnbudget", &mnbudget, true, true, false},
        {"medallion", "preparebudget", &preparebudget, true, true, false},
        {"medallion", "submitbudget", &submitbudget, true, true, false},
        {"medallion", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"medallion", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"medallion", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"medallion", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"medallion", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"medallion", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"medallion", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"medallion", "checkbudgets", &checkbudgets, true, true, false},
        {"medallion", "mnsync", &mnsync, true, true, false},
        {"medallion", "spork", &spork, true, true, false},
        {"medallion", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"medallion", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use medalliond, or the -server option to medallion-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> medallion-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:46633/\n";
}
