...
In order to support loading of multiple wallets in medallion-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is medallion.cpp.
...
Changes to medallion.cpp
----------------------
medallion.cpp is the entry point into medallion-qt, and as such, will require some minor modifications to provide hooks for
